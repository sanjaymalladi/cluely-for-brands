...
export const brands: Brand[] = [
  ...
  },
  {
    id: 'offwhite',
    name: 'Off-White',
    logo: '/brands/off-white.png',
    tagline: 'High-contrast, streetwear edge',
    baseDescription: 'Off-White brand aesthetic: high-contrast streetwear edge, bold typography, industrial elements, monochromatic palette with accent colors, urban aesthetic, contemporary fashion',
    colorPalette: ['#000000', '#FFFFFF', '#FF6B35', '#808080'],
    styleKeywords: ['high-contrast', 'streetwear', 'edge', 'bold', 'industrial']
  },
  {
    id: 'supreme',
    name: 'Supreme',
